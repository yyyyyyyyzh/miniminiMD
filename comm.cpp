...
// used to be in class Comm
MMD_float slablo[MAXSWAP];
MMD_float slabhi[MAXSWAP];
int pbc_any[MAXSWAP];
int pbc_flagx[MAXSWAP];
int pbc_flagy[MAXSWAP];
int pbc_flagz[MAXSWAP];
int sendproc[MAXSWAP];
int recvproc[MAXSWAP];
int sendproc_exc[MAXSWAP];
int recvproc_exc[MAXSWAP];
int sendnum[MAXSWAP];
int recvnum[MAXSWAP];
int comm_send_size[MAXSWAP];
int comm_recv_size[MAXSWAP];
int reverse_send_size[MAXSWAP];
int reverse_recv_size[MAXSWAP];
int firstrecv[MAXSWAP];
int maxsendlist[MAXSWAP];
int sendlist[MAXSWAP][MAXSEND];

int nsend_thread[MAXTHREADS];
int nrecv_thread[MAXTHREADS];
int nholes_thread[MAXTHREADS];
// int maxsend_thread[MAXTHREADS];
int exc_sendlist_thread[MAXTHREADS][MAXSEND];
int send_flag[MAXATOM];
...
*/
  ...
  // TODO: before run, check if MAXSWAP > maxswap
  ...
  for(i = 0; i < maxswap; i++) maxsendlist[i] = MAXSEND;
